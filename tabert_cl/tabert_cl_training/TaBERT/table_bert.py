...
from TaBERT.config import TableBertConfig
...
class TableBertModel(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        bert_model: BertModel = kwargs.pop('bert_model', None)
        ...
        **override_config: Dict
        ...
        if cls == TableBertModel:
            if 'num_vertical_attention_heads' in config_dict:
                from TaBERT.vertical_attention_table_bert import VerticalAttentionTableBert, VerticalAttentionTableBertConfig
                table_bert_cls = VerticalAttentionTableBert
                config_cls = VerticalAttentionTableBertConfig
            else:
                from TaBERT.vanilla_table_bert import VanillaTableBert
    ...
    def from_pretrained(
        ...
        **kwargs
        ...
        from TaBERT.vertical_attention_table_bert import (
